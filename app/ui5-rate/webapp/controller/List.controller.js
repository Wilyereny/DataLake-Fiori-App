sap.ui.define([
    ...
    return BaseController.extend("com.trm.cap.rates.ui5rate.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("FROM_CURR", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.trm.cap.rates.ui5rate.view.ViewSettingsDialog",
                    controller: this
