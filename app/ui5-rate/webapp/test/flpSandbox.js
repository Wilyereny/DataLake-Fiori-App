		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rates",
									"targetURL": "#comtrmcapratesui5rate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtrmcapratesui5rate-display": {
								"semanticObject": "comtrmcapratesui5rate",
								"action": "display",
								"description": "A Fiori application for rates",
								"title": "Rates",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.trm.cap.rates.ui5rate",
									"url": sap.ui.require.toUrl("com/trm/cap/rates/ui5rate")
								}
							}
						}
					}
